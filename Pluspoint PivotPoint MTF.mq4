      ...
      if(ObjectFind(0,"Fhr_R1 label")!=0)
        {
         ...
         ObjectSetText("Fhr_R1 label","Resistance (R1): "+DoubleToStr(Fhr_R1,4),8,"Arial",EMPTY);
        }
      else
        {
      ...
      if(ObjectFind("Fhr_R2 label")!=0)
        {
         ...
         ObjectSetText("Fhr_R2 label","Resistance (R2): "+DoubleToStr(Fhr_R2,4),8,"Arial",EMPTY);
        }
      else
        {
      ...
      if(ObjectFind("Fhr_R3 label")!=0)
        {
         ...
         ObjectSetText("Fhr_R3 label","Resistance (R3): "+DoubleToStr(Fhr_R3,4),8,"Arial",EMPTY);
        }
      else
        {
      ...
      if(ObjectFind("Fhr_P label")!=0)
        {
         ...
         ObjectSetText("Fhr_P label","Pivot Point (P): "+DoubleToStr(Fhr_P,4),8,"Arial",EMPTY);
        }
      else
        {
      ...
      if(ObjectFind("Fhr_S1 label")!=0)
        {
         ...
         ObjectSetText("Fhr_S1 label","Support (S1): "+DoubleToStr(Fhr_S1,4),8,"Arial",EMPTY);
        }
      else
        {
      ...
      if(ObjectFind("Fhr_S2 label")!=0)
        {
         ...
         ObjectSetText("Fhr_S2 label","Support (S2): "+DoubleToStr(Fhr_S2,4),8,"Arial",EMPTY);
        }
      else
        {
      ...
      if(ObjectFind("Fhr_S3 label")!=0)
        {
         ...
         ObjectSetText("Fhr_S3 label","Support (S3): "+DoubleToStr(Fhr_S3,4),8,"Arial",EMPTY);
        }
      else
        {
      ...
      if(ObjectFind("Fhr_S1 line")!=0)
        {
         ...
         ObjectSet("Fhr_S1 line",OBJPROP_COLOR,indicator_color1);
        }
      else
        {
      ...
      if(ObjectFind("Fhr_S2 line")!=0)
        {
         ...
         ObjectSet("Fhr_S2 line",OBJPROP_COLOR,indicator_color1);
        }
      else
        {
      ...
      if(ObjectFind("Fhr_S3 line")!=0)
        {
         ...
         ObjectSet("Fhr_S3 line",OBJPROP_COLOR,indicator_color1);
        }
      else
        {
      ...
      if(ObjectFind("Fhr_R1 line")!=0)
        {
         ...
         ObjectSet("Fhr_R1 line",OBJPROP_COLOR,Yellow);
        }
      else
        {
      ...
      if(ObjectFind("Fhr_R2 line")!=0)
        {
         ...
         ObjectSet("Fhr_R2 line",OBJPROP_COLOR,Yellow);
        }
      else
        {
      ...
      if(ObjectFind("Fhr_R3 line")!=0)
        {
         ...
         ObjectSet("Fhr_R3 line",OBJPROP_COLOR,Yellow);
        }
      else
        {
