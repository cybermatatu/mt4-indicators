...
#property indicator_color1 HotPink  // arrow up for moving average
#property indicator_color2 HotPink  // arrow down for moving average
...
#property indicator_color6 White  // dot
#property indicator_color7 HotPink  // dot
   ...
   while(pos>=0)
     {
      ...
      if (rsi > 60 )   //white dot
        {
         ExtMapBuffer6[pos]=wma + 0.0007;
        }
      if (stochm > 80)
        {
          ExtMapBuffer7[pos]=wma + 0.0008;
        }
